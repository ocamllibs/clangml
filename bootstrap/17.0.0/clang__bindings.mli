...
type constcxindexoptions
external create_index_with_options :
  constcxindexoptions -> cxindex = "clang_createIndexWithOptions_wrapper"
[@@ocaml.doc "Provides a shared context for creating translation units."]
...
type cxcursorkind =
  ...
  | OMPErrorDirective [@ocaml.doc "OpenMP error directive."]
  | TranslationUnit
...
external get_unqualified_type :
  cxtype -> cxtype = "clang_getUnqualifiedType_wrapper"[@@ocaml.doc
                                                         "Retrieve the unqualified variant of the given type, removing as little sugar as possible."]
external get_non_reference_type :
  cxtype -> cxtype = "clang_getNonReferenceType_wrapper"[@@ocaml.doc
...
external cxxmethod_is_deleted :
  cxcursor -> bool = "clang_CXXMethod_isDeleted_wrapper"[@@ocaml.doc
...
external cxxmethod_is_copy_assignment_operator :
  cxcursor -> bool = "clang_CXXMethod_isCopyAssignmentOperator_wrapper"
[@@ocaml.doc
  "Determine if a C++ member function is a copy-assignment operator, returning 1 if such is the case and 0 otherwise."]
external cxxmethod_is_move_assignment_operator :
  cxcursor -> bool = "clang_CXXMethod_isMoveAssignmentOperator_wrapper"
[@@ocaml.doc
  "Determine if a C++ member function is a move-assignment operator, returning 1 if such is the case and 0 otherwise."]
external cxxmethod_is_explicit :
  cxcursor -> bool = "clang_CXXMethod_isExplicit_wrapper"[@@ocaml.doc
...
type cxbinaryoperatorkind =
  | Invalid
  [@ocaml.doc "This value describes cursors which are not binary operators."]
  | PtrMemD [@ocaml.doc "C++ Pointer - to - member operator."]
  | PtrMemI [@ocaml.doc "C++ Pointer - to - member operator."]
  | Mul [@ocaml.doc "Multiplication operator."]
  | Div [@ocaml.doc "Division operator."]
  | Rem [@ocaml.doc "Remainder operator."]
  | Add [@ocaml.doc "Addition operator."]
  | Sub [@ocaml.doc "Subtraction operator."]
  | Shl [@ocaml.doc "Bitwise shift left operator."]
  | Shr [@ocaml.doc "Bitwise shift right operator."]
  | Cmp [@ocaml.doc "C++ three-way comparison (spaceship) operator."]
  | LT [@ocaml.doc "Less than operator."]
  | GT [@ocaml.doc "Greater than operator."]
  | LE [@ocaml.doc "Less or equal operator."]
  | GE [@ocaml.doc "Greater or equal operator."]
  | EQ [@ocaml.doc "Equal operator."]
  | NE [@ocaml.doc "Not equal operator."]
  | And [@ocaml.doc "Bitwise AND operator."]
  | Xor [@ocaml.doc "Bitwise XOR operator."]
  | Or [@ocaml.doc "Bitwise OR operator."]
  | LAnd [@ocaml.doc "Logical AND operator."]
  | LOr [@ocaml.doc "Logical OR operator."]
  | Assign [@ocaml.doc "Assignment operator."]
  | MulAssign [@ocaml.doc "Multiplication assignment operator."]
  | DivAssign [@ocaml.doc "Division assignment operator."]
  | RemAssign [@ocaml.doc "Remainder assignment operator."]
  | AddAssign [@ocaml.doc "Addition assignment operator."]
  | SubAssign [@ocaml.doc "Subtraction assignment operator."]
  | ShlAssign [@ocaml.doc "Bitwise shift left assignment operator."]
  | ShrAssign [@ocaml.doc "Bitwise shift right assignment operator."]
  | AndAssign [@ocaml.doc "Bitwise AND assignment operator."]
  | XorAssign [@ocaml.doc "Bitwise XOR assignment operator."]
  | OrAssign [@ocaml.doc "Bitwise OR assignment operator."]
  | Comma [@ocaml.doc "Comma operator."][@@deriving refl][@@ocaml.doc
                                                           "Describes the kind of binary operators."]
external get_binary_operator_kind_spelling :
  cxbinaryoperatorkind -> string =
    "clang_getBinaryOperatorKindSpelling_wrapper"[@@ocaml.doc
                                                   "Retrieve the spelling of a given CXBinaryOperatorKind."]
external get_cursor_binary_operator_kind :
  cxcursor -> cxbinaryoperatorkind =
    "clang_getCursorBinaryOperatorKind_wrapper"[@@ocaml.doc
                                                 "Retrieve the binary operator kind of this cursor."]
type cxunaryoperatorkind =
  | Invalid
  [@ocaml.doc "This value describes cursors which are not unary operators."]
  | PostInc [@ocaml.doc "Postfix increment operator."]
  | PostDec [@ocaml.doc "Postfix decrement operator."]
  | PreInc [@ocaml.doc "Prefix increment operator."]
  | PreDec [@ocaml.doc "Prefix decrement operator."]
  | AddrOf [@ocaml.doc "Address of operator."]
  | Deref [@ocaml.doc "Dereference operator."]
  | Plus [@ocaml.doc "Plus operator."]
  | Minus [@ocaml.doc "Minus operator."]
  | Not [@ocaml.doc "Not operator."]
  | LNot [@ocaml.doc "LNot operator."]
  | Real [@ocaml.doc "\"__real expr\" operator."]
  | Imag [@ocaml.doc "\"__imag expr\" operator."]
  | Extension [@ocaml.doc "__extension__ marker operator."]
  | Coawait [@ocaml.doc "C++ co_await operator."][@@deriving refl][@@ocaml.doc
                                                                    "Describes the kind of unary operators."]
external get_unary_operator_kind_spelling :
  cxunaryoperatorkind -> string =
    "clang_getUnaryOperatorKindSpelling_wrapper"[@@ocaml.doc
                                                  "Retrieve the spelling of a given CXUnaryOperatorKind."]
external get_cursor_unary_operator_kind :
  cxcursor -> cxunaryoperatorkind =
    "clang_getCursorUnaryOperatorKind_wrapper"[@@ocaml.doc
...
external ext_int_get_significant_bits :
  cxint -> int = "clang_ext_Int_getSignificantBits_wrapper"
...
external ext_designated_init_expr_get_field_decl :
  cxcursor -> int -> cxcursor =
    "clang_ext_DesignatedInitExpr_getFieldDecl_wrapper"
...
type clang_ext_availableonlyindefaultevalmethod_spelling =
  ...
  | SpellingNotCalculated [@@deriving refl]
external ext_available_only_in_default_eval_method_get_spelling :
  cxcursor -> clang_ext_availableonlyindefaultevalmethod_spelling =
    "clang_ext_AvailableOnlyInDefaultEvalMethod_getSpelling_wrapper"
...
type clang_ext_cfguard_spelling =
  | Declspec_guard 
  | GNU_guard 
  | CXX11_clang_guard 
  | C2x_clang_guard 
  | SpellingNotCalculated [@@deriving refl]
external ext_cfguard_get_spelling :
  cxcursor -> clang_ext_cfguard_spelling =
    "clang_ext_CFGuard_getSpelling_wrapper"
...
type clang_ext_maybeundef_spelling =
  | GNU_maybe_undef 
  | CXX11_clang_maybe_undef 
  | C2x_clang_maybe_undef 
  | SpellingNotCalculated [@@deriving refl]
external ext_maybe_undef_get_spelling :
  cxcursor -> clang_ext_maybeundef_spelling =
    "clang_ext_MaybeUndef_getSpelling_wrapper"
...
type clang_ext_nvptxkernel_spelling =
  | GNU_nvptx_kernel 
  | CXX11_clang_nvptx_kernel 
  | C2x_clang_nvptx_kernel 
  | SpellingNotCalculated [@@deriving refl]
external ext_nvptxkernel_get_spelling :
  cxcursor -> clang_ext_nvptxkernel_spelling =
    "clang_ext_NVPTXKernel_getSpelling_wrapper"
...
type clang_ext_nouwtable_spelling =
  | GNU_nouwtable 
  | CXX11_clang_nouwtable 
  | C2x_clang_nouwtable 
  | SpellingNotCalculated [@@deriving refl]
external ext_no_uwtable_get_spelling :
  cxcursor -> clang_ext_nouwtable_spelling =
    "clang_ext_NoUwtable_getSpelling_wrapper"
...
type clang_ext_readonlyplacement_spelling =
  | GNU_enforce_read_only_placement 
  | CXX11_clang_enforce_read_only_placement 
  | C2x_clang_enforce_read_only_placement 
  | SpellingNotCalculated [@@deriving refl]
external ext_read_only_placement_get_spelling :
  cxcursor -> clang_ext_readonlyplacement_spelling =
    "clang_ext_ReadOnlyPlacement_getSpelling_wrapper"
...
type clang_ext_targetversion_spelling =
  | GNU_target_version 
  | CXX11_gnu_target_version 
  | C2x_gnu_target_version 
  | SpellingNotCalculated [@@deriving refl]
external ext_target_version_get_spelling :
  cxcursor -> clang_ext_targetversion_spelling =
    "clang_ext_TargetVersion_getSpelling_wrapper"
...
type clang_ext_unsafebufferusage_spelling =
  | GNU_unsafe_buffer_usage 
  | CXX11_clang_unsafe_buffer_usage 
  | C2x_clang_unsafe_buffer_usage 
  | SpellingNotCalculated [@@deriving refl]
external ext_unsafe_buffer_usage_get_spelling :
  cxcursor -> clang_ext_unsafebufferusage_spelling =
    "clang_ext_UnsafeBufferUsage_getSpelling_wrapper"
...
external ext_hlslresource_binding_attr_get_slot_length :
  cxcursor -> int = "clang_ext_HLSLResourceBindingAttr_getSlotLength_wrapper"
...
external ext_hlslresource_binding_attr_get_slot :
  cxcursor -> string = "clang_ext_HLSLResourceBindingAttr_getSlot_wrapper"
...
external ext_target_version_attr_get_names_str_length :
  cxcursor -> int = "clang_ext_TargetVersionAttr_getNamesStrLength_wrapper"
...
external ext_hlslresource_binding_attr_get_space :
  cxcursor -> string = "clang_ext_HLSLResourceBindingAttr_getSpace_wrapper"
type clang_ext_hlslresourceattr_resourceclass =
  | SRV 
  | UAV 
  | CBuffer 
  | Sampler [@@deriving refl]
external ext_hlslresource_attr_get_resource_type :
  cxcursor -> clang_ext_hlslresourceattr_resourceclass =
    "clang_ext_HLSLResourceAttr_getResourceType_wrapper"
...
type clang_ext_ompinteropinfo
external ext_ompdeclare_variant_attr_get_append_args :
  cxcursor -> (clang_ext_ompinteropinfo -> unit) -> unit =
    "clang_ext_OMPDeclareVariantAttr_getAppendArgs_wrapper"
...
external ext_ompdeclare_variant_attr_get_append_args_size :
  cxcursor -> int =
    "clang_ext_OMPDeclareVariantAttr_getAppendArgs_Size_wrapper"
...
external ext_external_source_symbol_attr_get_usrlength :
  cxcursor -> int = "clang_ext_ExternalSourceSymbolAttr_getUSRLength_wrapper"
...
external ext_hlslresource_binding_attr_get_space_length :
  cxcursor -> int =
    "clang_ext_HLSLResourceBindingAttr_getSpaceLength_wrapper"
...
external ext_external_source_symbol_attr_get_usr :
  cxcursor -> string = "clang_ext_ExternalSourceSymbolAttr_getUSR_wrapper"
external ext_target_version_attr_get_names_str :
  cxcursor -> string = "clang_ext_TargetVersionAttr_getNamesStr_wrapper"
